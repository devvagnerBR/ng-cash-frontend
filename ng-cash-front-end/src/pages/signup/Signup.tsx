            ...
            <section className="form-side-signup">
                ...
                <section className="grid-signup">
                    <section className="signup-title">
                        <h1>Criar Conta</h1>
                        <p>Bem vind <span>x</span> a familia NG.CASH</p>
                    </section>
                    <form onSubmit={handleSubmit} className="signup-form">
                        ...
                        <section className="welcome">
                            {showInputPassword ? <div className="delay-container animeLeft">
                                <h1 >E ai, {username.data}</h1>
                                <h2 >Crie uma senha para proteger sua conta
                                    Ela precisa ter <span> 8 caracteres ou mais e
                                        ao menos um número e uma letra  maiúscula.</span>
                                </h2>
                                <Input
                                    placeholder="@Neox"
                                    label='Sua senha'
                        ...
                        <section className="btn-login-container">
                            <p>já tem uma conta? <span onClick={() => GO_T0_LOGIN( navigate )}>entrar!</span></p>
